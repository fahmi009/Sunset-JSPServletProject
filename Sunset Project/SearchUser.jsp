...
<title>Insert title here</title>
 ...
 <% String searchUser = (String) session.getAttribute("otherEmail"); %>
</head>
...
<br><br><br><br> <br>
 ...
 <h1> ${otherEmail}  Profile</h1>
 <form action = "follow" method="post" action="ControlServerlet">
 <input type = "checkbox" name = "Follows" /> Follow/Unfollow
