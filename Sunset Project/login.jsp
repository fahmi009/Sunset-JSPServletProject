...
<br><br><br><br> <br>
  <div class="container">
  <h1>Fill in the form to log in</h1>
    <form action = "main" method="post" action="ControlServerlet">
    ...
    <form class="btn" action = "registerpage" method="post" action="ControlServerlet">
